import { authorizedDomainsTroubleshooting } from "./firebaseAuthorizedDomainsHint";
...
export function formatFirebaseAuthError(err) {
  ...
  if (
    ...
    return [
      ...
      "3) Under “Authorized JavaScript origins”, add http://localhost:3000 (and your production URL, https://…).",
